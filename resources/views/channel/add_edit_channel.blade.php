                ...
                <div class="col-xl-12 col-md-12 col-sm-12">
                    <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="channel" id="channel" placeholder="Enter number of channel" value="{{ $data->channel ?? ''}}">
                                        </div>
                                    </div>
                        ...
                        <div class="card-footer text-end">
                            <a href="{{url('/channel')}}" class="btn btn-danger w-sm">Cancel</a>
