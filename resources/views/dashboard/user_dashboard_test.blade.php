...
{{-- @extends( ($is_company_login == 'true') ? 'front.layout_admin.company_app' : 'front.layout_admin.app') --}}
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-4 account_summary_div">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-4 alert-div">
                            <div class="card overflow-hidden">
                                    ...
                                    <div class="my_saving">
                                        <div class="row mb-4  bg-custom">
                                            ...
                                            <div class="col-8 col-xl-8 mt-4">
                                               <span class="total-co2 mt-2 number-size number-font">0 </span> <span class="total-co2-text mt-2 number-size number-font"> LBS OF CO2</span>
                                            </div>
                                        </div>
                                        <div class="row mb-4 bg-custom">
                                            <div class="col-4 col-xl-4">
                                            ...
                                            <div class="col-8 col-xl-8 mt-4">
                                                 </span><span class="total-fule-saving mt-2 number-size number-font">0 </span> <span class="total-fule-saving-text mt-2 number-size number-font"> GAL OF FUEL</span>
                                            </div>
                                        </div>
                                        <div class="row bg-custom">
                                            ...
                                            <div class="col-8 col-xl-8 mt-4">
                                                </span><span class="total-fuel-consumption-symbol mt-2 number-size number-font">$ </span><span class="total-fuel-consumption mt-2 number-size number-font">0 </span> <span class="total-fuel-consumption-text mt-2 number-size number-font"> IN FUEL COST</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    function accountSummery(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data){
                    $('.account_summery_body .users_count').html(data.user_count)
    ...
    //                 data = JSON.parse(data);
    //             } catch(e){}
    //             if(data && data.high_run_time){
    //                 $.each(data, function (key, usage) {
    //                     var iconClass, label, value;

    //                     switch (key) {
    //                         case "high_run_time":
    //                             iconClass = "fa-clock-o";
    //                             label = "Highest Run Time";
    //                             value = usage.high_run_time+' (S)';
    //                             break;

    //                         case "solar_generated_power":
    //                             iconClass = "fa-bolt";
    //                             label = "Solar Generated Power";
    //                             value = usage.solar_generated_power+' (Wh)';
    //                             break;

    //                         case "fule_saved":
    //                             iconClass = "zmdi zmdi-gas-station";
    //                             label = "Fuel Saved";
    //                             value = '$ '+usage.fule_saved;
    //                             break;
    ...
    //                                 <img src="{{url('theme-asset/images/POWRBANK.png')}}" alt="powrbank">
    //                             </div>
    //                             <div class="activity-details d-flex">
    //                                 <div>
    //                                     <b>
    //                                         <span class="text-dark fs-20">${label}</span>
    //                                     </b>
    //                                     <div class="ms-auto fs-16 mt-1">${usage.device_name} : <span class="badge bg-primary text-white badge-custom">${value}</span></div>
    //                                 </div>
    ...
    //                     $(".power_bank_usage").append(activityHtml);
    //                 });
    ...
    //                 $('.spinner_power_bank_usage').remove();
    //                 $('.power_bank_usage').removeClass('d-none');
    //                 $(".power_bank_usage").html('');
    //                 $(".power_bank_usage").html('<p>No POWRBANK usage found.</p>');
    //             }
    //         }
    //     });
    // }
