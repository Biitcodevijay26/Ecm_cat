                ...
                <div class="row">
                    <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9">
                        <div class="card card-options-chart-maximize chart-height">
                            ...
                            {{-- <div class="card-body selection-scroll" id="exportChartDiv"> --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                                ...
                                <form action="{{ url('export-testing-chart-csv') }}" id="exportCSV" method="post" style="display: inline;">
                                    @csrf
        ...
        $(document).ready(function() {
            ...
            function addDynamicGraphData() {
                ...
                if(chkCount > 0)
                {
                    ...
                    myChart.update();
                    $.ajax({
                        url: '{{ url('get-testing-charts-data') }}',
                        type: "POST",
            ...
            function formatDate(dateString) {
                ...
                // Format the date string as 'DD.MON'
            ...
            function updateLableInterval(tickLimit){
                ...
                for (let i = 0; i < labels.length; i++) {
                    // Modify label names here, for example, appending ' - Modified' to each label
                ...
                for (let i = 0; i < modifiedLabels.length; i++) {
                    // Check if the label needs to be modified
