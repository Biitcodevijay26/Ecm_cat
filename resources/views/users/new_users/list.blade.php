        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="ms-auto pageheader-btn">
                    <?php if($company_login_id) : ?>
                        <a href="{{url('/company/'.$company_login_id.'/new-user-add')}}" class="btn btn-primary btn-icon text-white me-2">
                            <span>
                                <i class="fe fe-plus"></i>
                            </span> Add User
                        </a>
                    <?php else : ?>
                    <a href="{{url('new-user-add')}}" class="btn btn-primary btn-icon text-white me-2">
                        <span>
                            <i class="fe fe-plus"></i>
                        </span> Add User
                    </a>
     ...
     $(document).ready(function() {
        ...
        $(document).on('click', '.activeInactiveByAdmin', function() {
            ...
            $('.alert-outline-success').remove();
                ...
                $.ajax({
                    url: '{{url("active-inactive-new-users")}}',
                    type: "POST",
                    data:  {id:id},
                    headers: {
