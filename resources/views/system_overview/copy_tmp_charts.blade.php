                            ...
                            <div class="card-body selection-scroll">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input chkBox" name="chk_a[]"
                                                data-text="Gen_C_L1(A)" data-value="Battery" value="A" data-key="Current">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input chkBox" name="chk_a[]"
                                                data-text="Gen_C_L2(A)" data-value="Battery" value="A" data-key="Current">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input chkBox" name="chk_a[]"
                                                data-text="Gen_C_L3(A)" data-value="Battery" value="A" data-key="Current">
