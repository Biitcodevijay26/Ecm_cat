                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                    <div class="card card-border-unit card-border-radius device-card-height justify-content-center unit-card card-machine-off machine-off battry-card-height card-z-index">
                                        ...
                                        <div class="row text-center">
                                            <div class="col-12">
                                                <div class="card-body p-4">
                                                    <img src="{{ $activeUnitIcon }}" alt="img" class="img-fluid mt-2 unit-img-on d-none" style="width: 120px">
                                                    <img src="{{ $inactiveUnitIcon }}" alt="img" class="img-fluid mt-2 unit-img-off" style="width: 120px">
