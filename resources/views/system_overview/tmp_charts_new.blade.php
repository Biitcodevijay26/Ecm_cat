                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                        <div class="card h-100">
                            <div class="card-header pb-2">
                                <h3 class="device-card-title">Create Chart</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select2 form-control" name="chart-type" id="chart-type">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0);" class="btn btn-primary btn-icon text-white pull-right me-2">
                                    <span>
