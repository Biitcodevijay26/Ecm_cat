...
@if ($cluster_list)
    @foreach ($cluster_list as $cluster)
        <div class="col-md-12 cluster_found">
            <div class="card {{ $cluster->status == 1 ? 'card-border-black' : 'card-border-black'}} card-collapsed">
                <div class="card-header {{ $cluster->status == 1 ? 'bg-color-black' : 'bg-color-black'}}">
                    <a href="javascript:void(0);" class="card-options-collapse text-white" data-bs-toggle="card-collapse">
                    <h4 class="card-title-overview-page text-white"> {{$cluster->name ?? ''}} </h4>
                    </a>
                ...
                <div class="card-body">
                    <div class="row">
                    @if ($cluster->device && count($cluster->device) > 0)
                    @foreach ($cluster->device as $device)
                        <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="card-body p-4">
                                                            ...
                                                            <?php
                                                            if (isset($device->system_calculated) && $device->system_calculated['data']['data']) {
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                                            <div class="card card-border-warning card-border-radius device-card justify-content-center">
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="card-body p-4">
                                                            <h5 class="card-kw-number-1 custom-color-warning  mb-0">POWRBANK Details</h5>
                    ...
                    @endforeach
                    @else
                        <h6 class="card-title">No POWRBANK Found..!</h6>
                    @endif
                    </div>
                </div>
            </div>
