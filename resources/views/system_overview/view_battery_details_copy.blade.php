                            ...
                            <div class="row d-flex justify-content-start">
                                ...
                                <?php if ($company_login_id) : ?>
                                    ...
                                    <?php if(auth()->guard('admin')->user()->role_id == $adminRoleId) : ?>
                                        ...
                                        <a href="{{url('/company/'.$company_login_id.'/remort-access/'.$id)}}" class="btn bg-color-default text-black  device-btn-width device-btn-text me-2 remort_access_btn mb-2" style="width:260px !important">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-between">
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-3">
                                    <div class="card card-border-primary card-border-radius device-card-height justify-content-center card-z-index generator-card card-machine-off machine-off">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="circle-icon text-center align-self-center box-primary-shadow mt-5">
                                                    <img src="{{ url('theme-asset/images/charging.svg') }}" alt="img" class="img-fluid generator-img-on d-none">
                                                    <img src="{{ url('theme-asset/images/charging-off.svg') }}" alt="img" class="img-fluid generator-img-off">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-3">
                                    ...
                                    <div class="card card-border-danger card-border-radius device-card-height justify-content-center card-z-index acdc-card card-machine-off machine-off">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="circle-icon text-center align-self-center box-primary-shadow mt-5">
                                                    <img src="{{ url('theme-asset/images/ac-dc-solar-xl-icon.svg') }}" alt="img" class="img-fluid acdc-img-on d-none">
                                                    <img src="{{ url('theme-asset/images/ac-dc-solar-xl-off-icon.svg') }}" alt="img" class="img-fluid acdc-img-off">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="card-body p-4">
                                        ...
                                        <div class="row text-center">
                                            <div class="col-12">
                                                <div class="card-body p-4">
                                                    ...
                                                    <img src="{{ url('theme-asset/images/battery_full_icon.svg') }}" alt="img" class="img-fluid mt-2 battery-img-on d-none">
                                                    <img src="{{ url('theme-asset/images/battery_full_icon_off.svg') }}" alt="img" class="img-fluid mt-2 battery-img-off">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-3">
                                    <div class="card card-border-black card-border-radius device-card-height justify-content-center card-z-index grid-card card-machine-off machine-off">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="circle-icon text-center align-self-center box-primary-shadow mt-5">
                                                    <img src="{{ url('theme-asset/images/tower.svg') }}" alt="img" class="img-fluid grid-img-on d-none">
                                                    <img src="{{ url('theme-asset/images/tower-off.svg') }}" alt="img" class="img-fluid grid-img-off">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="card-body p-4">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-3">
                                    <div class="card card-border-success  card-border-radius device-card-height justify-content-center card-z-index load-card card-machine-off machine-off">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="circle-icon text-center align-self-center box-primary-shadow mt-5">
                                                    <img src="{{ url('theme-asset/images/load.svg') }}" alt="img" class="img-fluid load-img-on d-none">
                                                    <img src="{{ url('theme-asset/images/load-xl-off-icon.svg') }}" alt="img" class="img-fluid load-img-off">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="card-body p-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function set_system_calculated(json){
            if(json.data)
            {
                var Genrator_to_battery_Power     = json.data['Genrator_to_battery_Power(W)'];
                if( typeof Genrator_to_battery_Power !== 'undefined')
                {
        ...
        function set_sub_system_calculated(json){
            if(json.data)
            {
                var Solar_to_Grid             = json.data['Solar_to_Grid(KWh)'];
                var Solar_to_battery_Power    = json.data['Solar_to_battery_Power(W)'];
                var Grid_to_battery_Power     = json.data['Grid_to_battery_Power(W)'];
                var Genrator_to_battery_Power = json.data['Genrator_to_battery_Power(W)'];

                if( typeof Solar_to_Grid !== 'undefined')
                {
        ...
        function turn_on_animation(json){
            var contain = json.data.Contain
            console.log("is_latest_data : ",contain);
            let P_DC = '';
            if(contain == "Battery")
            {
